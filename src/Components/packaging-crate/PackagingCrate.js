...
import "./PackagingCrate.css";
import CatalogueNavbar from "../catalogue-navbar/CatalogueNavbar";
import Footer from "../footer/Footer";
import products from "../../packagingCrate.json";

const PackagingCrate = () => {
  ...
  return (
    <Fragment>
      ...
      <div className="product-details-container">
        <div className="product-crate-container">
